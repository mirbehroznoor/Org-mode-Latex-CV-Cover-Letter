...
I tried to write my CV and Cover Letter in Org-mode, unfortunately I could not find any suitable solutions. Although there were few CVs but most of them had used a lot of LaTex syntax. Thus, here I have tried to reduce the amount of *LaTex* syntax and use *Org* syntax as much as possible. However, I must say Org-mode and LaTex complement each other really well as you will see with these CVs.
