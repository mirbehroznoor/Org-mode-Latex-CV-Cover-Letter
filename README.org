...
Since I tried to write my CV and Cover Letter in Org-mode, I could not find any satisfactory solutions. Although there were few but most of them use a lot of LaTex syntax. Thus, here I have tried to reduce the amount of =LaTex= syntax and use =Org= syntax as much as possible. However, I must say Org-mode and Latex complement each other really well as you will see with these CVs.
